...
export type { MemberProfile as Member, ProfileEntry, ProfilePatch } from '@dinnerorder/server/types';
...
async function readErrorDetail(response: Response): Promise<string | undefined> {
  let body: { error?: string; ingredientId?: string; birthMonth?: string; issues?: { path: string; message: string }[] };
  try {
